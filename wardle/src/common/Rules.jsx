        ...
        <>
          ...
          <div>
            ...
            <section className="reglas">
              ...
              <img src={tabla1} alt="Tabla de Costos de Letras" className="tabla" />
    
              <h4>Tabla de Precios de Power-ups</h4>
              <img src={tabla2} alt="Tabla de Precios de Power-ups" className="tabla tabla-pequena" />
              
              <h4>Probabilidades de Power-ups por Personaje</h4>
              <img src={tabla3} alt="Tabla de Probabilidades" className="tabla" />
            </section>
          </div>
        </>
    );
