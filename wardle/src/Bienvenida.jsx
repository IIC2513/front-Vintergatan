    ...
    return (
        <div>
          ...
          <section className="reglas">
            ...
            <h4 className="ecuacion">P = (G×1) + (A×3) + (V×5) − (I×0.5)</h4>
            <p>Donde:</p>
            <ul>
            ...
            <h4 className="ecuacion">E = P + (W×B)</h4>
            <p>Donde:</p>
            <ul>
            ...
            <h4>Tabla de Costos de Letras</h4>
            <img src="/img/tabla1.png" alt="Tabla de Costos de Letras" className="tabla" />
    
            <h4>Tabla de Precios de Power-ups</h4>
            <img src="/img/tabla2.png" alt="Tabla de Precios de Power-ups" className="tabla tabla-pequena" />
            
            <h4>Probabilidades de Power-ups por Personaje</h4>
            <img src="/img/tabla3.png" alt="Tabla de Probabilidades" className="tabla" />
          </section>
        </div>
    );
}